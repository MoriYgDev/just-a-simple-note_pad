package ir.moris.justasimpletodoapp.feature_note.presentation.notes.components
    ...
    Scaffold(floatingActionButton = {
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = {
                    viewModel.onEvent(NotesEvent.ToggleNotesEvent)
                }) {
                    Icon(
            ...
            AnimatedVisibility(
                ...
                OrderSection(modifier = Modifier
                    .fillMaxWidth()
                    .padding(16.dp), noteOrder = state.noteOrder, onOrderChange = {
